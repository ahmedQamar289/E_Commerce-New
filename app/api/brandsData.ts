...
export const brandsData = {
  smartphones: {
    name: "📱 Smartphones",
    icon: "https://img.icons8.com/color/96/000000/iphone.png",
    color: "bg-blue-100",
  },
  laptops: {
    name: "💻 Laptops",
    icon: "https://img.icons8.com/color/96/000000/laptop.png",
    color: "bg-purple-100",
  },
  fragrances: {
    name: "🌸 Fragrances",
    icon: "https://img.icons8.com/color/96/000000/perfume-bottle.png",
    color: "bg-pink-100",
  },
  skincare: {
    name: "💄 Skincare",
    icon: "https://img.icons8.com/color/96/000000/lipstick.png",
    color: "bg-rose-100",
  },
  groceries: {
    name: "🛒 Groceries",
  ...
  furniture: {
    name: "🪑 Furniture",
    icon: "https://img.icons8.com/color/96/000000/chair.png",
    color: "bg-amber-100",
  },
  tops: {
    name: "👕 Tops",
    icon: "https://img.icons8.com/color/96/000000/t-shirt.png",
    color: "bg-green-100",
  },
  "womens-dresses": {
  ...
  "mens-shirts": {
    name: "👔 Men's Shirts",
    icon: "https://img.icons8.com/color/96/000000/shirt.png",
    color: "bg-slate-100",
  },
  "mens-shoes": {
    name: "👞 Men's Shoes",
    icon: "https://img.icons8.com/color/96/000000/mens-shoe.png",
    color: "bg-gray-100",
  },
  "mens-watches": {
    name: "⌚ Men's Watches",
  ...
  "womens-bags": {
    name: "👜 Women's Bags",
    icon: "https://img.icons8.com/color/96/000000/handbag.png",
    color: "bg-cyan-100",
  },
  "womens-jewellery": {
  ...
  motorcycle: {
    name: "🏍️ Motorcycle",
    icon: "https://img.icons8.com/color/96/000000/motorcycle.png",
    color: "bg-orange-100",
  },
};
